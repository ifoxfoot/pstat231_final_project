...
We tried different methods to predict the size of a fire in case a wildfire occurs including linear regression, K-NN regression, random forest regression, and boosted trees. 
