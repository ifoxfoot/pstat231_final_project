...
#library(raster) #used for extracting vegetation
...
#predict values using training data
predictions_train <- predict(fire_size_rf, data = fire_train)

#calculate rmse for training data
RMSE(predictions_train, fire_train$fire_size)

#calculate test error

#predict values using test data
predictions_test <- predict(fire_size_rf, data = fire_test)

#calculate rmse for training data
RMSE(predictions_test, fire_test$fire_size)
```
